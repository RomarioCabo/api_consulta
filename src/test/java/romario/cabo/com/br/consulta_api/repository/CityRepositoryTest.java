...
public class CityRepositoryTest {
    ...
    /*
     * Teste deve retornar falso se o id não existir
     * */
    @Test
    public void mustReturnFalseIfIdDoesNotExists() {
        // cenário
        stateRepository.deleteAll();
        cityRepository.deleteAll();
    ...
    private City getCity(Long idState) {
        City city = new City();
        city.setState(getState(idState));
        city.setName("Russas");

        return city;
    }

    private State getState(Long idState) {
